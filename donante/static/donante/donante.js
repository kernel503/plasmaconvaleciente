$(document).ready(function () {
    ...
    bootstrapValidate('#id_nombre', 'max:50:No debe superar los 50 caracteres!|required:Por favor rellene este campo!');
    ...
    $('#addDonante').on('hidden.bs.modal', function () {
        ...
        $('#id_poseeTransporte option')[0].selected = true;
        $('#id_tipoDeSangre option')[0].selected = true;
    })
